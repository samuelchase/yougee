...
var GaeMiniProfiler = {
    ...
    expand: function(elEntry, data) {
        ...
        var toggleLogRows = function(level) {
            ...
            $('#profilerSlider .minlevel-text').text(names[level]);
            $('#profilerSlider .loglevel').attr('class', 'loglevel ll'+level);
        ...
        if ($('#profilerSlider .control').slider) {
            initLevel = 30;
            $('#profilerSlider .control').slider({
                value: initLevel,
                min: 10,
                max: 50,
                step: 10,
